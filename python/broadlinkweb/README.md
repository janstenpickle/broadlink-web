...
## Development environment and release process
 ...
 - create virtualenv with Flask and broadlink-web installed into it (latter is installed in
...
install it (`pip install broadlinkweb.tar.gz`), ensure that configuration file exists and
`BROADLINKWEB_SETTINGS` environment variable points to it, ensure that user has access to the
